#!/bin/bash                                              
#SBATCH --job-name=RTS_expanded_Benders_16repweeks_generator5_HS_LP_GBD
#SBATCH --ntasks=1
...
julia -t 32 --project=../../../ ../run_Benders_16repweeks_expanded_RTS_change_generator_number.jl 1 5 4