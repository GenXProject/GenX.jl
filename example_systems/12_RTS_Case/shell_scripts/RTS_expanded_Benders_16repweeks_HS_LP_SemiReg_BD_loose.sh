#!/bin/bash                                              
#SBATCH --job-name=RTS_expanded_Benders_16repweeks_HS_LP_SemiReg_BD_loose
#SBATCH --ntasks=1
...
julia -t 32 --project=../../../ ../run_Benders_16repweeks_expanded_RTS_speedup_strategies.jl 0 1 6