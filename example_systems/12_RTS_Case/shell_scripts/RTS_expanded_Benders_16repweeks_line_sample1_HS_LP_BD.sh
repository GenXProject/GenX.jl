#!/bin/bash                                              
#SBATCH --job-name=RTS_expanded_Benders_16repweeks_line_sample1_HS_LP_BD
#SBATCH --ntasks=1
...
julia -t 32 --project=../../../ ../run_Benders_16repweeks_expanded_RTS_line_subsamplings.jl 0 1 4