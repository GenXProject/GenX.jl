...
function hydro_inter_period_linkage!(EP::Model, inputs::Dict)
    ...
    @constraint(
        EP,
        cSoCBalLongDurationStorageStart_H[w = 1:REP_PERIOD, y in STOR_HYDRO_LONG_DURATION],
    ...
    @constraint(
        EP,
        cSoCBalLongDurationStorageUpper_H[
            y in STOR_HYDRO_LONG_DURATION,
            r in MODELED_PERIODS_INDEX,
        ],
    ...
    @constraint(
        EP,
        cSoCBalLongDurationStorageSub_H[
            y in STOR_HYDRO_LONG_DURATION,
