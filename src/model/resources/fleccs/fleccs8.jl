...
function fleccs8(EP::Model, inputs::Dict, FLECCS::Int, UCommit::Int, Reserves::Int)
    ...
    @expression(EP, ePower_asu[y in FLECCS_ALL,t=1:T],  FLECCS_parameters[!,:pPowerUseRate_lox][y] * vLOX_in[y,t])
    # auxillary load
	...
	@expression(EP, eLOX_out[y in FLECCS_ALL,t=1:T],  FLECCS_parameters[!,:pO2UseRate][y] * vP_oxy[y,t])
