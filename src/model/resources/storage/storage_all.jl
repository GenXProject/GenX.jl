...
function storage_all(EP::Model, inputs::Dict, Reserves::Int, OperationWrapping::Int)
	...
	@constraints(EP, begin
		...
		[y in STOR_ALL, t in 1:T], EP[:eTotalCapEnergy][y] >= dfGen[y,:Min_Duration] * EP[:eTotalCap][y]
		[y in STOR_ALL, t in 1:T], EP[:eTotalCapEnergy][y] <= dfGen[y,:Max_Duration] * EP[:eTotalCap][y]
