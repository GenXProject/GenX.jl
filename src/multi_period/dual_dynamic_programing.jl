...
function write_multi_period_outputs(stats_d::Dict, outpath::String, settings_d::Dict)
    ...
    write_capacities_discharge(outpath, sep, settings_d)
    #write_capacities_charge(outpath, sep, settings_d)
    #write_capacities_energy(outpath, sep, settings_d)
    #write_network_expansion(outpath, sep, settings_d)
    write_costs(outpath, sep, settings_d)
