...
function configure_settings(settings_path::String)
    ...
    # No JuMP String name reporting at model generation by default, to expedite model generation; 1 if JuMP string names need to be enabled
    set_default_if_absent!(settings, "EnableJuMPStringNames", 0)
