...
|$\bigtriangleup\varphi^{cap}_{l}$ | Additional transmission capacity added to line $l$ [MW] |
|$\varphi^{cap}_{l}$ | Transmission capacity of line $l$ [MW] |
...
|$\overline{\varphi^{cap}_{l}}$ | Existing transmission capacity of line $l$ [MW] |
